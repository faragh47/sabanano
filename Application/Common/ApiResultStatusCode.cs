...
namespace Common
{
    public enum ApiResultStatusCode
    {
        ...
        NotAllowedToChangeOrder = 82,
        [Display(Name = "در این وضعیت سفارش  اعمال تغییز وجود ندارد")]
        ...
        OrderExists = 126,
        [Display(Name = "کدپستی تکراری است")]
        PostalCodeMustBeUnique = 126,
        [Display(Name = "کد مشتری تکراری است")]
        CustomerCodeMustBeUnique = 127,
        [Display(Name = "غذا باید توسط رستوران آماده شده باشد.")]
        OrderStatusMustBeReady = 128,
        [Display(Name = "رستوران باید قابلیت رزور را داشته باشد")]
        RestaurantMusHaveReservasion = 129,
        [Display(Name = "چت مورد نظر یافت نشد")]
        ChatNotFound = 130
    }
}
