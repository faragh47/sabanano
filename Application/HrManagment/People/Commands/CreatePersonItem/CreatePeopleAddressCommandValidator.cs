...
public class CreatePeopleAddressCommandValidator : AbstractValidator<CreatePeopleAddressCommand>
{
    private readonly IRepository<PeopleAddress> _repository;

    public CreatePeopleAddressCommandValidator(IRepository<PeopleAddress> repository)
    {
