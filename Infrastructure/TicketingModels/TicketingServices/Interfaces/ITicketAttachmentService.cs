...
{
    public interface ITicketAttachmentService : ICrudService<TicketAttachmentCuDto, TicketAttachmentListDto, TicketAttachmentSearchDto, TicketAttachment, long>, IScopedDependency
    {
    }
}
